...
jQuery(document).ready(function () {
  ...
  /*HOMEPAGE CAROUSEL STARTS*/ (function () {
  ...
  /*TIPSY STARTS*/
  if (jQuery().tipsy) {
    jQuery("#social-01").tipsy({
      gravity: 'n'
    });
    jQuery("#social-02").tipsy({
      gravity: 'n'
    });
    jQuery("#social-03").tipsy({
      gravity: 'n'
    });
    jQuery("#social-04").tipsy({
      gravity: 'n'
    });
    jQuery("#social-05").tipsy({
      gravity: 'n'
    });
    jQuery("#social-06").tipsy({
      gravity: 'n'
    });
    jQuery("#social-07").tipsy({
      gravity: 'n'
    });
    jQuery("#social-07").tipsy({
      gravity: 'n'
    });
    jQuery("#social-08").tipsy({
      gravity: 'n'
    });
    jQuery("#social-09").tipsy({
      gravity: 'n'
    });
    jQuery("#social-10").tipsy({
      gravity: 'n'
    });
    jQuery("#social-11").tipsy({
      gravity: 'n'
    });
    jQuery("#team-01").tipsy({
      gravity: 's'
    });
  }
  /*TIPSY ENDS*/
